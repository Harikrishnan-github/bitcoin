...
IsMineResult IsMineInner(const CKeyStore& keystore, const CScript& scriptPubKey, IsMineSigVersion sigversion)
{
    ...
    case TX_PUBKEY:
        ...
        if (keystore.HaveKey(keyID)) {
            Update(ret, IsMineResult::SPENDABLE);
        }
        break;
    case TX_WITNESS_V0_KEYHASH:
    {
        ...
        Update(ret, IsMineInner(keystore, GetScriptForDestination(CKeyID(uint160(vSolutions[0]))), IsMineSigVersion::WITNESS_V0));
        break;
    }
    case TX_PUBKEYHASH:
    ...
    case TX_SCRIPTHASH:
    {
        ...
        if (keystore.GetCScript(scriptID, subscript)) {
            Update(ret, IsMineInner(keystore, subscript, IsMineSigVersion::P2SH));
        }
        break;
    }
    case TX_WITNESS_V0_SCRIPTHASH:
    {
        ...
        CScript subscript;
        if (keystore.GetCScript(scriptID, subscript)) {
            Update(ret, IsMineInner(keystore, subscript, IsMineSigVersion::WITNESS_V0));
        }
        break;
    }
